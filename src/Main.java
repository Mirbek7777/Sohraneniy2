...
public class Main {
    public static void main(String[] args) {
        ...
        saveGame("C://Game/savegames/save1.dat", progressOne);
        saveGame("C://Game/savegames/save2.dat", progressTwo);
        saveGame("C://Game/savegames/save3.dat", progressThree);

        zipFiles1("C://Game/savegames/zip.zip", "C://Game/savegames/save1.dat",
                "C://Game/savegames/save2.dat",
                "C://Game/savegames/save3.dat");

        deleteFiles("C://Game/savegames/save1.dat",
                "C://Game/savegames/save2.dat",
                "C://Game/savegames/save3.dat");
